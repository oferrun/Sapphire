...
static const DeviceId InvalidDeviceId = (unsigned int) - 1;
/// An invalid device button ID.
static const DeviceButtonId InvalidDeviceButtonId = (unsigned int)-1;
/// An invalid user button ID.
static const UserButtonId InvalidUserButtonId = (unsigned int)-1;
